...
class CvesFact(Base):
    ...
    cves_severity = relationship("CvesSeverity", back_populates="cves_fact_relation")
    cves_scores = relationship("CvesScores", back_populates="cves_fact_relation")
    cves_attack_vectors = relationship("CvesAttackVectors", back_populates="cves_fact_relation")
